...
Base.Ship (room, 'my_ship', (0.044375,-0.319167,3), (0, 0.902829, -0.43), (-1, 0, 0))

room = Base.Room ('Pirate_Concourse')
room1 = room
...
Base.Link (room0, 'my_link_id', 0.5875, -0.36, 0.2975, 0.573333, 'Pirate_Concourse', room1)
import bar_lib
bar = bar_lib.MakeBar (room1,time_of_day,'pirates','bases/bar/MiningBase_Bar',True,True,'mining_base',False,[('mb1',-0.333346875,-0.2012725515464)])
...
Base.Link (room1, 'commodity', 0.705, -0.62, 0.255, 0.423333, 'Commodity_Exchange', commodity)
Base.Comp (room1, 'my_comp_id', 0.485, -0.443333, 0.1475, 0.163333, 'Mission_Computer', 'Missions News ShipDealer Info ')
#Base.Link (room1, 'my_link_id', -0.9625, -0.976667, 1.92, 0.33, 'Landing_Pad', room0)
Base.Link (room1, 'my_link_id', -.5, 0.1, .3, 0.33, 'Landing_Pad', room0)
