...
def XGUITypesTest():
    ...
    for t in XGUITypesRootSingleton.enumFactories():
        debug.info(t.getDesc())
    
    debug.info(XGUITypesRootSingleton.getFactory("int4").parse("int4","(3.3,3.4,4,4.6)"))
    debug.info(XGUITypesRootSingleton.getFactory("float4").parse("float4","(3.3,3.4,4,4.6)"))
    debug.info(XGUITypesRootSingleton.getFactory("int[4]").parse("int[4]","(3.3,3.4,4,4.6)"))
    debug.info(XGUITypesRootSingleton.getFactory("float[4]").parse("float[4]","(3.3,3.4,4,4.6)"))
    debug.info(XGUITypesRootSingleton.getFactory("i2f2").parse("i2f2","(3.3,3.4,4,4.6)"))
