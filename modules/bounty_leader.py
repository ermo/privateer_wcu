...
class bounty_leader(bounty.bounty):
	def __init__ (self, minnumsystemsaway, maxnumsystemsaway, creds, run_away, shipdifficulty, enemyfaction, jumps=(), var_to_set='', namefg='', dyntype="", displayLocation=1, dynhelperfg='', dynhelpertype='', greetingText=['It appears we have something in common, privateer.','My name may be on your list, but now your name is on mine.'], leader_upgrades=[], dockable_unit=False):
		bounty.bounty.__init__(self, minnumsystemsaway, maxnumsystemsaway, creds, run_away, 0, enemyfaction, jumps, var_to_set, namefg, dyntype, displayLocation, greetingText, dockable_unit)
