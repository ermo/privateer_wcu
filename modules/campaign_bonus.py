...
def LoadBonusCampaign():
    ...
    MakeMission(priv,
        ...
        MakeMission(priv,
            ...
            AddCredits(11000),
            None,
            'escort_local',('pirates',0,4,2,3000,0,True,'militia',('Gemini/Nexus','Gemini/Junction','Gemini/J900','Gemini/Telar'),priv.name+"_mission",'','talon','','paradigm',[('By order of the Militia High Command, All pirate affiliated craft must stand down.',True,'cmapaign/syrai4.wav'),'You are to surrender your base at once!','Any starship not powered down will be considered in volation of Confederate Law.',("This is Syrai: I can't believe you double crossed me.  Pirates across the galaxy will hear of this!",False),]),
            priv.name+"_mission",
            destinee5speech,
            None,
            CampaignEndNode(priv),
    ...
    MakeMission(priv,
        ...
        AddCredits(18000),
        None,
        "escort_local",('hunter',0,2,2,3000,0,False,'confed',(),priv.name+"_mission",'','demon','','drayman',[("We've been paid to decimate that drayman and nothing is getting in our way",False,"campaign/kaydence7.ogg"),("Stand down by the order of Confed High Command!",True),"Stand down and we may spare you, escorts. You are at our mercy, now"]),
        priv.name+"_mission",
        kaydence7speech,
        None,
        CampaignEndNode(priv),
    ...
    MakeMission(priv,
        ...
        MakeMission(priv,
            ...
            AddCredits(15000),
            None,
            'escort_local',('pirates',0,6,2,3000,0,True,'militia',('Gemini/Nexus','Gemini/KM-252'),priv.name+"_mission",'','talon','','paradigm',[('By order of the Militia High Command, All pirate affiliated craft must stand down.',True,'cmapaign/destinee6.ogg'),'You are to surrender your base at once!','Any starship not powered down will be considered in volation of Confederate Law.',]),
            priv.name+"_mission",
            destinee7speech,
            None,
            CampaignEndNode(priv),
    ...
    MakeMission(priv,
        ...
        'escort_local',('hunter',0,1,6,3000,0,True,'AWACS',(),priv.name+"_mission",'','demon','','drayman',[("Prisoner transport. You are hereby under arrest. If you do not comply you will be destroyed!",False,"campaign/demetria1.ogg"),("Stand down. This is the AWACS personell transport. We owe nothing to Confed and will not surrender to you goons. You don't work for the Star Confederacy in the same way I don't.",True),("You've been paid off  by those corporate fascists!",True)]),
        priv.name+"_mission",
        demetria1speech,
        None,
        CampaignEndNode(priv),
