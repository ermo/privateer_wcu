...
class cleansweep(patrol_enemies.patrol_enemies):
	def __init__(self, numsystemsaway, num_points, distance, creds, jumps, donevar, minships, maxships, encounterprob, capshipprob, faction, forceattack, canrunaway, fgname="", scan_objects=None):
		patrol_enemies.patrol_enemies.__init__(self, numsystemsaway, num_points, distance, creds, jumps, donevar, minships, maxships, encounterprob, capshipprob, faction, forceattack, fgname, scan_objects)
		self.enum=0
