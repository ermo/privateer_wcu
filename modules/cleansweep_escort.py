...
class cleansweep_escort(cleansweep.cleansweep):
    def __init__(self, numsystemsaway, num_points,distance, creds,jumps, donevar, minships, maxships, encounterprob, capshipprob, faction, forceattack, canrunaway, friendlyfaction, allygreetingtext=[], lastnum=3, enemygreetingtext=[], fgname="", scan_objects=None):
        cleansweep.cleansweep.__init__(self, numsystemsaway, num_points, distance, creds, jumps, donevar, minships, maxships, encounterprob, capshipprob, faction, forceattack, canrunaway, fgname, scan_objects)
