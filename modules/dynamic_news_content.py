...
all_faction_name_global = {
    ...
    #possessive -> form that denotes ownership
    #mstandname -> standard male name
    #fstandname -> standard female name
    #deftype -> what group of ships should be called
    "alltags": ["full","nicks","nickp","dnicks","dnickp","government","possessive","homeworld","mstandname","fstandname","deftype",]
    ,"privateer": {"full": ["Private Space Freelancers"]
        ,"nicks": ["privateer"]
        ,"nickp": ["privateers"]
        ,"dnicks": ["ronin"]
        ,"dnickp": ["ronins"]
        ,"government": ["privateer community"]
        ,"possessive": ["privateer's"]
        ,"homeworld": ["privateer hangouts"]
        ,"mstandname": ["John Drake"]
        ,"fstandname": ["Anna Peers"]
        ,"deftype": ["flightgroup"]
        }
    ,"confed": {"full": ["Terran Confederation of Planets"]
        ...
        ,"dnicks": ["conpie"]
        ,"dnickp": ["conpies"]
        ,"government": ["Confederation Senate"]
        ,"possessive": ["Confed's"]
        ,"homeworld": ["Earth"]
        ,"mstandname": ["David Hatch"]
        ,"fstandname": ["Mariam Mourad"]
        ,"deftype": ["strike wing"]
        }
    ,"border_worlds": {"full": ["Union of Border Worlds"]
        ,"nicks":["borderworlder"]
        ,"nickp":["borderworlders"]
        ,"dnicks":["patchworker"]
        ,"dnickp":["patchworkers"]
        ,"government":["Border Worlds Council"]
        ,"possessive":["Border World's"]
        ,"homeworld": ["Deneb"]
        ,"mstandname": ["President Bradley"]
        ,"fstandname": ["Christine Keller"]
        ,"deftype": ["strike wing"]
        }
    ,"AWACS": {"full": ["Armed Workers Against Corporate Slavery"]
        ...
        ,"possessive": ["the people's"]
        ,"homeworld": ["Auriga"]
        ,"mstandname": ["Marcus Dibnaevski"]
        ,"fstandname": ["Serena Romano"]
        ,"deftype": ["red army flight"]
        }
    ,"merchant": {"full": ["Merchant's Union"]
        ...
        ,"possessive": ["merchant's"]
        ,"homeworld": ["Earth"]
        ,"mstandname": ["James Stroffs"]
        ,"fstandname": ["Amanda Barnard"]
        ,"deftype": ["trade convoy"]
        }
    ,"militia": {"full": ["Starsystem Guardsmen"]
        ,"nicks": ["militia"]
        ,"nickp": ["militias"]
        ,"dnicks": ["jackboot"]
        ,"dnickp": ["fuzz"]
        ,"government": ["Starsystem Defense"]
        ,"possessive": ["militia's"]
        ,"homeworld": ["local startsystem"]
    ...
    ,"kilrathi": {"full": ["Kilrathi Empire"]
        ...
        ,"dnicks":["kitty"]
        ,"dnickp": ["kitties"]
        ,"government": ["Kilrathi Emperor"]
        ,"possessive": ["kilrathi's"]
        ,"homeworld": ["Kilrah"]
        ,"mstandname": ["Thrakhath"]
        ,"fstandname": ["Kt'lan"]
        ,"deftype": ["strike wing"]
        }
    ,"retro": {"full": ["Church of Man"]
        ,"nicks": ["churchman"]
        ,"nickp": ["churchmen"]
        ,"dnicks": ["retro"]
        ,"dnickp": ["retros"]
        ,"government": ["Clergy"]
        ,"possessive": ["church's"]
        ,"mstandname": ["Brother Jones"]
        ,"fstandname": ["Sister Keyes"]
        ,"deftype": ["church battalion"]
        }
    ...
    ,"hunter": {"full": ["Bounty Hunter's Guild"]
        ...
        ,"dnicks": ["vulture"]
        ,"dnickp": ["vultures"]
        ,"government": ["Bounty Hunter's Guild Council"]
        ,"possessive": ["hunter's"]
        ,"homeworld":["the Mercenary Guild Seat"]
        ,"mstandname": ["Vart Nemkis"]
        ,"fstandname": ["Mir Karok"]
        ,"deftype": ["attack group"]
        }
    ,"unknown": {"full": ["unknown forces"]
        ...
        ,"dnicks": ["shadow"]
        ,"dnickp": ["shadows"]
        ,"government": ["unknown entity"]
        ,"possessive": ["unknown's"]
        ,"homeworld": ["the great unknown"]
        ,"mstandname": ["???"]
        ,"fstandname": ["???"]
        ,"deftype": ["mysterious formation"]
        }
    ...
    ,"firekkan": {"full": ["Firekkan Ascendency"]
        ...
        ,"homeworld": ["Firekka"]
        ,"mstandname": ["Larrhi"]
        ,"fstandname": ["Teehyn Ree"]
        ,"deftype": ["flight"]
        }
    ,"civilian": {"full": ["Civilians"]
        ,"nicks": ["civilian"]
        ,"nickp": ["civilians"]
        ,"dnicks": ["civvie"]
        ,"dnickp": ["civvies"]
        ,"government": ["Central Government"]
        ,"possessive": ["civilian's"]
        ,"homeworld": ["Earth"]
...
# Fill missing factions with data from unkown.
for f in faction_ships_lists.factions:
    if f not in all_faction_name_global:
        all_faction_name_global[f]=all_faction_name_global["unknown"]
# Fill missing notfactions with data from unkown.
for f in faction_ships_lists.notfactions:
    if f not in all_faction_name_global:
        all_faction_name_global[f]=all_faction_name_global["unknown"]
...
"neutral":
    {"siege":
        ...
        ,"middle":
            ...
            ,"draw":
                {"good": [(0.8,"all","I believe this is done, but just not sent to me0x17")]
        ...
        ,"end":
            ...
            ,"draw":
                {"good": [(0.8,"all","need a story later, when siege implemented properly0x19")]
    ...
    ,"fleetbattle":
        {"start":
            {"success":
                ...
                ,"neutral": [(0.3,"all","VAR_aggressor_possessive VAR_aggressor_deftype Sighted!\\Confirmed reports have been received of a VAR_aggressor_possessive VAR_aggressor_deftype grid-searching VAR_system_system space. Unconfirmed reports that the VAR_aggressor_deftype is hunting a VAR_defender_possessive VAR_defender_FGtype Class raiding party have also been received. GNN will monitor these events, seeking the reason behind such aggressive actions of the VAR_aggressor_nickp.\\\\GNN -- we report the inane news!")]
                }
            ,"draw":
                {"bad": [(0.3,"all","Flagship Damaged, VAR_aggressor_deftype to Continue Pursuit in VAR_system_system !\\In a brief encounter yesterday, the VAR_aggressor_FGtype Class VAR_aggressor_FG suffered minor damage after inflicting heavy casualties on a VAR_defender_possessive raiding party. While the flagship has heaved to for repairs, the remainder of the VAR_aggressor_deftype will continue to prosecute the VAR_defender_possessive raiding party, now with extreme prejudice.")]
                ,"good": [(0.3,"all","VAR_aggressor_dnicks VAR_aggressor_deftype Repulsed in VAR_system_system!\\A VAR_defender_possessive VAR_defender_deftype encountered a a VAR_aggressor_dnicks VAR_aggressor_deftype yesterday. GNN has just received reports that, while suffering minor damage, the convoy managed to disable the VAR_aggressor_FGtype Class VAR_aggressor_FG, flagship of the VAR_aggressor_deftype.\\Will the convoy manage to escape the VAR_aggressor_deftype, and flee into the protective arms of its defense force? Will the VAR_aggressor_deftype be sent ahead of their crippled flagship? Stay online.")]
                ,"neutral": [(0.3,"all","Battle in the VAR_system_system System!\\While in pursuit of a VAR_defender_possessive raiding party, the flagship of the VAR_aggressor_possessive Strike Fleet, the VAR_aggressor_FGtype Class VAR_aggressor_FG sustained damage to its engines. In the exchange of fire, however, the VAR_aggressor_deftype inflicted serious damage on the raiding party. The raiding party is currently attempting to reach a friendly system, where it expects a VAR_defender_possessive Defense Force will provide support in repulsing the pursuing strike fleet.\\\\Updates to follow.")]
                }
            ,"loss":
                {"good": [(0.3,"all","Running Through VAR_system_system With Their Tail Between Their Legs!\\A VAR_aggressor_dnicks VAR_aggressor_deftype was sent fleeing earlier today after encountering several VAR_defender_FGtype, class vessels from the Defense Forces in VAR_system_system System. After several days of being illegally pursued by this strike fleet, a VAR_defender_possessive VAR_defender_deftype was welcomed into the protective arms of the Defense Force. After several parting volleys of weapons fire, the VAR_aggressor_dnicks ran as fast as possible for their own borders.\\It is wonderful, is it not, when we can have a successful trade convoy, AND kick the VAR_aggressor_dnickp where it hurts!\\\\This is GNN -- enjoying the fruits of another's labour!")]
                ,"bad": [(0.3,"all","Strike Fleet Forced to Retreat From VAR_system_system!\\Earlier today, a VAR_aggressor_possessive VAR_aggressor_deftype pursuing a VAR_defender_possessive raiding party retreated from an untenable encounter. Upon entry to the VAR_system_system System, detection equipment registered multiple VAR_defender_possessive VAR_defender_FGtype class ships in defensive formation around the raiding party. After trading several volleys of primary weapons fire, the VAR_aggressor_possessive VAR_aggressor_deftype retreated to friendlier space. The VAR_aggressor_government has called upon all available reserves, and is moving ships from other lines of battle. Now the battle is upon us - WAR!")]
                ,"neutral": [(0.3,"all","VAR_aggressor_possessive VAR_aggressor_deftype in Tactical Retreat From VAR_system_system.\\Earlier today, a VAR_aggressor_possessive VAR_aggressor_deftype in pursuit of a VAR_defender_possessive raiding party retreated back to friendlier space after encountering unexpected resistance. After jumping into VAR_system_system System, the VAR_aggressor_deftype planned to corner and destroy the raiding party, recovering all stolen goods in the process. Instead, the VAR_aggressor_deftype encountered VAR_defender_FGtype class ships drawn up in defensive order. Laying down a defensive screen of weapons fire, the VAR_aggressor_deftype jumped back to its own borders.\\ The VAR_aggressor_government is currently reinforcing the VAR_aggressor_deftype with forces from other battle lines.\\Will this reinforced VAR_aggressor_deftype re-enter battle? Stay online.")]
                }
            }
        ,"middle":
            {"success":
                {"good": [(0.3,"all","VAR_aggressor_possessive VAR_aggressor_deftype Mission Success!\\It has been confirmed that the VAR_defender_possessive raiding party, wanted for atrocities in VAR_aggressor_government systems, has been destroyed. In a series of running battles, the outmaneuvered, outgunned, and outclassed raiding party was whittled away, piece by piece.\\However, with VAR_defender_possessive forces on alert, the VAR_aggressor_deftype is now staging to jump out, returning to friendlier space. It is believed that the VAR_defender_possessive forces may not be able to reach the jump point in time to halt the strike fleet.")]
                ,"bad": [(0.3,"all","Trade Convoy Lost! Perpetrators Expected to Escape!\\Another VAR_defender_deftype was torn to pieces yesterday, with system defense forces caught looking the other way. Having hailed the VAR_defender_possessive VAR_defender_deftype under flag of truce, the VAR_aggressor_possessive Strike Force caught the defenseless convoy with its shields down. Formal protests have been lodged with VAR_aggressor_government concerning this vile deed.\\Meanwhile, it is very much a possibility that the VAR_aggressor_deftype will escape from VAR_system_system space before interception by VAR_defender_possessive forces.\\Will such atrocities go unpunished?")]
                ,"neutral": [(0.3,"all","VAR_aggressor_possessive VAR_aggressor_deftype Success! Now the Voyage Home.\\A VAR_defender_possessive raiding party as destroyed in VAR_system_system System today by VAR_aggressor_nicks forces. With continued pinprick attacks, the VAR_defender_possessive raiding party was reduced, ship by ship.\\Further, other defensive forces in the area had been drawn to the other side of the system by a series of false communications messages. Woefully out of position, it is believed that they will not be able to blockade the jump points leading outsystem before the VAR_aggressor_deftype can escape.\\Stay online for further developments.")]
                }
            ,"draw":
                {"bad": [(0.3,"all","Destruction of VAR_defender_possessive Raiding Party.\\Our reporters in the field were able to release the following report. The VAR_aggressor_possessive Strike Fleet, currently in VAR_system_system System, engaged and crushed its prey, a VAR_defender_possessive Raiding Party. It is now, however, playing cat and mouse with the remaining VAR_defender_possessive defensive forces in that system as it seeks a jump point back to friendlier space.")]
                ,"good": [(0.3,"all","Another VAR_defender_deftype Massacred!\\It has been independently verified that a VAR_aggressor_dnicks VAR_aggressor_deftype in VAR_system_system System massacred the VAR_defender_deftype VAR_defender_FG. The VAR_defender_government has sent a strong protest to the VAR_aggressor_government about this terrorist act, and has proposed the reinforcement of defense forces already in the system. It is believed that those VAR_defender_possessive ships currently in the system will attempt to blockade the strike fleet, until sufficient forces have been raised to annihilate it. Stay online for more updates.")]
                ,"neutral": [(0.3,"all","Contact Escalates into Full Scale Battle!\\Following previous reports of a VAR_aggressor_possessive VAR_aggressor_deftype entering VAR_system_system System, our reporters in the field have confirmed the decimation of a VAR_defender_possessive VAR_defender_FGtype raiding party. Meanwhile, additional VAR_defender_possessive forces, having rushed to the battle site, are now engaging the VAR_aggressor_deftype as we report. VAR_dockedat_FGtype Class ships will remain at high readiness until this current crisis is over.\\\\GNN -- only the ridiculous is newsworthy!")]
            }
            ,"loss":
                {"good": [(0.3,"all","Rage at VAR_defender_deftype Attacks!\\Angered by the constant harassment of trade convoys, VAR_defender_possessive forces have engaged a VAR_aggressor_dnicks VAR_aggressor_deftype which had the temerity to enter VAR_system_system System. With the latest VAR_defender_deftype safely insystem, defensive forces have flanked and pushed back the invading strike fleet. With the VAR_aggressor_deftype currently on the run, additional VAR_defender_possessive forces are gathering to blockade the system's jumppoints. It is the intention of all VAR_defender_nicks forces, to send a message to all and sundry via the destruction of the VAR_aggressor_dnicks Strike Fleet.")]
                ,"bad": [(0.3,"all","VAR_defender_dnickp Block Withdrawal of VAR_aggressor_possessive Strike Fleet!\\After a legally sanctioned battle to destroy a VAR_defender_possessive raiding party, VAR_defender_possessive reinforcements have halted the withdrawal of the VAR_aggressor_possessive VAR_aggressor_deftype from the VAR_system_system System. VAR_defender_possessive forces have caused serious delays, all the while building to a force capable of eliminating the strike fleet. Will the VAR_aggressor_possessive VAR_aggressor_deftype survive? Will further forces be sent to their aid? Only time will tell.\\Stay online.\\\\On a related matter, the VAR_aggressor_full has sent a formal request to the VAR_defender_government to ---cease and desist this unjust persecution! Should it continue, we will have no choice but to send further forces to stabilize this system.--- We await the VAR_defender-government's reply.\\\\GNN -- the news that knows.")]
                ,"neutral": [(0.3,"all","Blockaded VAR_aggressor_deftype Seeks Friendly Jump Point.\\Such is the expected wanted ad we could expect from the VAR_aggressor_possessive VAR_aggressor_deftype currently in VAR_system_system System. It appears that the VAR_aggressor_deftype failed in its mission to destroy a VAR_defender_possessive raiding party. The situation gets worse for those forces however, with the VAR_defender_possessive Defense Force having blockaded all jump points out of the system. GNN believes that it is only a matter of time before the VAR_aggressor_deftype is cornered and brought down.\\\\GNN -- the news that will bring you to your knees.")]
                }
            }
        ,"end":
            {"success":
                {"good": [(0.3,"all","Strike Fleet Goes Above & Beyond the Call of Duty!\\Following on from previous reports, we can now announce that the VAR_aggressor_possessive VAR_aggressor_deftype VAR_aggressor_FG has exceeded all terms of its mission briefing. In a stunning display of deep space logistics and judicious use of brilliant battle tactics, the VAR_defender_possessive raiding party, condemned to destruction for atrocities committed in VAR_aggressor_full space, was vaporized as it neared sanctuary. To add insult to injury, this heroic fleet then totally destroyed all remaining defensive forces insystem, before jumping back to friendly space!\\What a success! What a truly outstanding feat of skill, daring and sheer luck! Several commendations, medals and awards are expected to be handed out in an awards ceremony to be held on the return of the fleet to drydock.\\But now we must consider, with VAR_system_system System now defenseless, whether to invade and annex that system, bringing to a halt all further raiding.\\\\GNN -- bringing the celebration to you.")
                ...
                ,"neutral": [(0.3,"all","Raiding Party and Defensive Forces Defeated.\\Although facing significant defensive forces to escape VAR_system_system System, the VAR_aggressor_possessive VAR_aggressor_deftype in VAR_system_system was able to achieve its primary mission objective the destruction of the VAR_defender_possessive raiding party. Further, while attempting to exit the system, the VAR_aggressor_deftype proceeded to eliminate or repel all remaining opposition forces. Reliable estimates show that 90% of all defense forces were repulsed or destroyed during the retreat to friendly space.\\Now we play the waiting game. Will the VAR_aggressor_government take the advantage and invade the defenseless system? Will the VAR_defender_government be able to reinforce the pitiful forces remaining insystem? Stay online and we will keep you informed.")
            ...
            ,"draw":
                ...
                ,"bad": [(0.8,"all","VAR_aggressor_nickp and VAR_defender_nickp eradicate each other in VAR_system_system\\In a sudden strike by the VAR_aggressor_nicks VAR_aggressor_FG fleet, what started as a well planned strategic missile assault went awry and both sides ended up fighting in a close, brutal beam battle. No starships were left intact and survivors are making their ways to their respective bases in escape pods. Privateers would be encouraged to assist transporting stray VAR_aggressor_possessive pilots to their respective stations in the VAR_system_system System in the VAR_system_sector Sector.\\\\GNN -- \"We care for our people too.\"")
                    ,(0.3,"all","Bloody Battle in VAR_system_system System!\\In a running engagement, a VAR_aggressor_possessive VAR_aggressor_deftype was forced to withdraw to friendlier space, being unable to hunt down a VAR_defender_possessive raiding party. With the quick response of the VAR_defender_possessive Defense Force, the VAR_aggressor_deftype was required to fight its way clear of the system.\\Things did not go all the way of the VAR_defender_nicks forces, however, with the VAR_aggressor_deftype inflicting heavy losses on the blockade forces.\\With such a result, it now remains to be seen as to whether the VAR_aggressor_nickp invade the system fully, or move back to a defensive stance.\\Stay online and we will bring updates as they happen.")]
            ...
            ,"loss":
                ...
                ,"bad": [(0.3,"all","VAR_aggressor_possessive VAR_aggressor_deftype Lost!\\The VAR_aggressor_government has been forced to admit the loss of its VAR_aggressor_deftype in the VAR_system_system System. While pursuing a VAR_defender_possessive raiding party, the VAR_aggressor_deftype encountered unexpected VAR_defender_nicks resistance. After exchanging fire, the VAR_aggressor_deftype attempted to retreat back to friendly space. Despite a stunning display of deep space tactics by the VAR_aggressor_nicks commander, the VAR_defender_possessive forces cornered and destroyed the wounded strike fleet. The VAR_aggressor_government has called for a period of mourning, meanwhile calling for the enlistment of all available personnel.\\We at GNN will honour this period of mourning with a 10 second period of silence ... now to other news.")
                ...
                ,"neutral": [(0.3,"all","VAR_aggressor_possessive VAR_aggressor_deftype Reduced to Cinders.\\After a series of running battles in the VAR_system_system System, a VAR_aggressor_possessive VAR_aggressor_deftype was destroyed by VAR_defender_possessive defense forces. Having chased a VAR_defender_possessive raiding party into the system, the VAR_aggressor_deftype encountered heavy resistance from defending forces arrayed against them. While attempting to retreat back to friendly space, the VAR_aggressor_deftype was brought to bay near an exit jump point. After several hours of battle, the last VAR_aggressor_FGtype Class ship was destroyed.\\The commander of the VAR_defender_nicks Defense Forces stated ---They invaded our territory, and have suffered the ultimate indignity. If the VAR_aggressor_dnickp come again, we'll wipe them out of their own systems too!---")
    ...
    ,"destroyed":
        {"end":
            {"success":
                {"good": [(0.6,"all","VAR_system_system: VAR_defender_FG Debris!\\Debris believed to be from the VAR_defender_FGtype of the VAR_defender_possessive Squadron VAR_defender_FG has been found today in VAR_system_system. This group is believed to be responsible for various attacks on VAR_dockedat_possessive installations in and around the area in the past few months, including an attack on Major General VAR_dockedat_mstandname's entorage. These VAR_defender_dnickp will not be missed by anyone around here.\\\\GNN -- \"We report REAL news\"")
                    ,(0.4,"player","Freelancer Helps the Cause in VAR_system_system!\\The VAR_aggressor_FG squadron adds another kill to their belts today, as they made short work of the VAR_defender_FGtype ships of the VAR_defender_possessive squadron VAR_defender_FG in VAR_system_system system. VAR_aggressor_FG has been one of the more prominent of the freelance mercenaries, helping to get rid of the the VAR_dockedat_possessive forces and helping our allies with many smaller scale attacks while the majority of our forces have been engaged on the frontlines. It is people like these that allow most of us to continue with our lives in peace.")
                    ,(0.9,"all","VAR_defender_possessive Patrol Mauled!\\A recent encounter between a VAR_defender_possessive border patrol and VAR_aggressor_nicks forces has resulted in the near total loss of all VAR_defender_possessive craft. The squad leader was the only survivor. After disabling her ship, the VAR_defender_possessive pilot was able to scan the remains of her destroyed patrol, before being forced to eject from her ship.\\Last report placed her ejection pod drifting slowly towards the systems's sun. If rescued early, the VAR_defender_dnickp may save the life of the pilot and find out what happened to their patrol. As time goes by and the chances of rescue grow smaller, we are reminded of the fragility of life in space.\\\\GNN -- Do you feel insignificant?")
                    ...
                    ,(0.6,"all","VAR_system_system: VAR_defender_FG Obliterated!\\Today fear struck into VAR_defender_possessive hearts as a lone ship destroyed the VAR_defender_FG in the VAR_system_system system.\\ The attack in VAR_system_system came without prior notice of any kind. It is thought, due to the markings on the attacking ship, that the hero of the day was a VAR_aggressor_FGtype. Rumors of a cloaking device abound, one relay beacon did detect a nearby jump point being activated but detected no ships coming through, moments later the VAR_defender_FG was destroyed.\\In an automated press release the VAR_defender_government announced that it would persue an eye-for-an-eye policy against the VAR_aggressor_nickp and that VAR_system_system would be purged of any space faring vessels with VAR_aggressor_nicks markings on it. A local mechanic reported that many ships have docked at his buisness to receive new paint jobs. One thing this reporter knows is that the VAR_defender_full is not likely to find the valliant ship captain that obliterated the VAR_defender_FG anywhere near VAR_system_system as he most probably jumped out of the system as fast as he jumped in.\\\\GNN -- \"The true story\"")]
...
# Fill missing factions with default.
for f in faction_ships_lists.factions:
    if f not in _all_news_global:
        _all_news_global[f]=_all_news_global["neutral"]
# Fill missing notfactions with default.
for f in faction_ships_lists.notfactions:
    if f not in _all_news_global:
        _all_news_global[f]=_all_news_global["neutral"]
