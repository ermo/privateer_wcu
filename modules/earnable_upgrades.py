...
#		["orionMk4.blank","starships/Hunter/Heavy",200000,200,3700,"The OrionMk4 is an upgraded version of the Hunter Orion featuring two weapon turrets."]
	...
	"irene":[
		["ferret.blank","starships/Militia/Light",40000,100,1000,"The Ferret is beginning to show its age bit it os still the premier patrol fighter in use by Confed forces. Rugged and simple design and exceptional flight characteristics make it ideal for scout roles."],
		...
		["ferretCVL.blank","starships/Militia/Light",45000,100,1000,"The Ferret is beginning to show its age bit it is still the premier patrol fighter in use by Confed forces. Rugged and simple design and exceptional flight characteristics make it ideal for scout roles."]
	],
	"avalon1":[
