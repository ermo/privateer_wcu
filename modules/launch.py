...
#       VS.playAnimation ("warp.ani",vec,300.0)
    if isinstance(type, list) or isinstance(type, tuple):
        ...
        isblank = not type.endswith(".blank") == -1
...
class Launch:
    ...
    def Preprocess (self):
        ...
        if self.dynfg != '':
            ...
            print 'Dynamically launching from SaveString flightgroup '+self.dynfg + ' with ships: '+str(tn)+' faction '+ self.faction
            knum=0
            if (tn!=[] and self.type!=''):
...
##          self.dynfg=''
                ...
                print "Dyn-Launch: tn=="+str(tn)+", dynfg=='"+str(self.dynfg)+"' getting random fighter"
    ...
    def launch(self,myunit):
        ...
        if (self.dynfg != ''):
            ...
            if ((not myunit) and self._nr_ships>0):
                ...
                print 'zero or negative number of ships, launching one'
