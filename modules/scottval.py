...
scottspeech1={"intro":[("Burrows","I'm looking for work."),
							("Governor_Scott","Thanks goodness! You're hired!"),
							("Burrows","But..."),
							("Governor_Scott","We're about to send out a frighter. It is about to be intercepted by a large pirate force. Defend it until it reaches the jump point. I'll pay 50000 credits."),
							("Burrows","I'm..."),
				...
				"reconsider":[("Burrows","Okay, tell me about the mission again."),
							("Governor_Scott","Defend our frighter from Pirates. I'll pay 50000 credits.")],
				"reject2":[("Burrows","That's not enough information."),
							("Governor_Scott","You fool! It's already too late. The frighter has been destroyed!")],
				...
				"reminder":[("Governor_Scott","What are you doing here?"),
							...
							("Governor_Scott","We need that deal! The frighter could be destroyed any moment! Move out NOW!"),
							("Burrows","Cool down, I'm a man who usually fulfills his mission objectives. I'll leave now.")],
				"failure":[("Governor_Scott","The frighter is destroyed! It will take us months to recover from this loss! Get away before I have you arrested!")]
				}
scottspeech2={"intro":[("Governor_Scott","The freighter... the freighter..."),
							("Burrows","The frighter has moved out. Cool down."),
							("Governor_Scott","Thanks goodness. We put all our hopes in this run. If we wouldn't have managed to bring the frighter out to New Caledonia, the base would have lost a lot of money."),
							("Burrows","Yeah, whatever you say, Mr...?"),
							("Governor_Scott","I'm sorry for my inpoliteness. My name is Mr. Scott, I am Governor of the Prasepe system and the head of this base."),
							...
							("Burrows","You mean you lost all your forces to thiefs, pirates and nut cases?"),
							("Governor_Scott","The problem is that our foes seem to have an infinite source of ships. Most likely, they were purchased from Governor Menesch, a corrupt Governor selling confed ships. I also think he managed to steal my ships. You might have heard about him."),
							("Burrows","Erm... yes, isn't that the guy who floods the sector with Talons?"),
							("Governor_Scott","Superficially. The last thing I heard of him was that he brought some Ferrets to the open market. And he'll surely make some extra credits with selling my Scimitars. But I think that's not his primary goal."),
							("Burrows","You're implying that he is not in this business for the money, right?"),
							("Governor_Scott","Menesch presumably is one of the richest humans alive, already. He doesn't need to make more money. I guess he tries to gain influence within the pirate clans, maybe within the Retros, and I believe he'd also be mean enough to deal with the Kilrathi."),
							("Burrows","That's a nice story, but how can I help you?"),
							("Governor_Scott","Ah yes. In case you want to keep on working for me, I have another mission for you. We need to take the heat away from Saratov. Therefore I need you to strike a pirate ship operating in this system."),
...
scottspeech3={"intro":[("Governor_Scott","The Drayman is history. Good job."),
							...
							("Governor_Scott","Because they nearly took control of it. The region around NC and J900 is infested with pirates and retros."),
							...
							("Burrows","So, what else can I do to help your base running?"),
							("Governor_Scott","Our last action catched additional attention within Menesch's corrupt strike teams. An assault force is approaching our base. We're currently assembling a defense squadron but I'd like you to help them out."),
							("Burrows","Tell me more details, please."),
				...
				"reject1":[("Burrows","3 against 6? I don't think this is a good idea, Governor."),
...
scottspeech4={"intro":[("Governor_Scott","Nice flying."),
							...
							("Governor_Scott","Yes. I've learnt that his ship is enroute to a secret meeting with a corrupt administrator from my base. We've arrested our guy, and are going to send you, instead, to kick their asses."),
							("Burrows","I assume this top dealer won't stumble around in an old Tarsus."),
...
scottsuccess=[("UNLOCKED: Scimitar."),
			("Governor_Scott","Awesome job! Here is your money. And good news: Our Insys forces have found a frighter full of our stolen ships."),
			("Burrows","Ferrets?"),
			("Governor_Scott","No. Imagine, we found our own Scimitars. We've got our full fighter squadron back! Since we're a lot safer now, I'm going to sell some of those ships to benefit the base. You're welcome to also buy one if you like."),
